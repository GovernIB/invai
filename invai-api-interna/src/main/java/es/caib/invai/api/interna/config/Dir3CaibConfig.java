...
public class Dir3CaibConfig {
     ...
     * {@code IntegrationUnavailableException} until this is configured with a real value.
     */
    ...
    /**
     * Builds the {@link WebClient} used by {@code Dir3CaibClient}, pre-configured with the
