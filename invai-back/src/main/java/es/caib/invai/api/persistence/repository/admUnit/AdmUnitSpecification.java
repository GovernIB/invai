 ...
 */
@NoArgsConstructor
public final class AdmUnitSpecification {
     ...
     * @return a JPA {@link Specification} object targeting AdmUnitEntity query environments
     */
    public static Specification<AdmUnitEntity> filterByCriteria(AdmUnitCriteria criteria) {
