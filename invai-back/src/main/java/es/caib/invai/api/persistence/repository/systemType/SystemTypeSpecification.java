 ...
 */
@NoArgsConstructor
public final class SystemTypeSpecification {
     ...
     * @return a JPA {@link Specification} object targeting SystemTypeEntity query environments
     */
    public static Specification<SystemTypeEntity> filterByCriteria(SystemTypeCriteria criteria) {
