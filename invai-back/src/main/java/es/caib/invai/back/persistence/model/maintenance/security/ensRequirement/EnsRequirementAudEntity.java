 ...
 * targeting the {@code INV_ENS_REQUIREMENT} database table.
 *
 * @since 1.0.4
 */
@Getter
@Setter
@Entity
@Table(name = "INV_ENS_REQUIREMENT_AUD")
public class EnsRequirementAudEntity {

    /** Unique auto-generated primary key of the audit record. */
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "inv_ens_requirement_aud_seq")
    @SequenceGenerator(name = "inv_ens_requirement_aud_seq", sequenceName = "INV_ENS_REQUIREMENT_AUD_SEQ", allocationSize = 1)
    @Column(name = "AUDIT_ID", nullable = false, updatable = false)
    private Long auditId;

    /** Identifier of the {@code EnsRequirementEntity} this audit snapshot refers to. */
    @Column(name = "ENS_REQUIREMENT_ID", nullable = false)
    private Long ensRequirementId;

    /** ENS requirement descriptive label captured at the time of the audited change. */
