 ...
 * and constraint validation checks targeting live {@link IdentityProviderEntity} records.
 *
 * @since 1.0.4
 */
@Repository
public interface IdentityProviderJPARepository extends JpaRepository<IdentityProviderEntity, Long>, JpaSpecificationExecutor<IdentityProviderEntity> {
