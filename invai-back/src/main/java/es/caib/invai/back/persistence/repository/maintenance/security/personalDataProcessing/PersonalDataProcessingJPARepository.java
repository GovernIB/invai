 ...
 * and constraint validation checks targeting live {@link PersonalDataProcessingEntity} records.
 *
 * @since 1.0.4
 */
@Repository
public interface PersonalDataProcessingJPARepository extends JpaRepository<PersonalDataProcessingEntity, Long>, JpaSpecificationExecutor<PersonalDataProcessingEntity> {
