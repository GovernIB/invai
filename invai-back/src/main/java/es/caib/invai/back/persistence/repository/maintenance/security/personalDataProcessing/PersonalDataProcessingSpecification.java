 ...
 * structures using the Criteria API targeting PersonalDataProcessing entities.
 *
 * @since 1.0.4
 */
@NoArgsConstructor
public final class PersonalDataProcessingSpecification {

    /**
     * Builds a JPA {@link Specification} that filters {@link PersonalDataProcessingEntity} records
     ...
     */
    public static Specification<PersonalDataProcessingEntity> filterByCriteria(PersonalDataProcessingCriteria criteria) {
