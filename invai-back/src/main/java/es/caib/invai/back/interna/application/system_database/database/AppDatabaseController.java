...
@Slf4j
@Validated
@Tag(name = "Bases de dades d'aplicació", description = "Servei de gestió de les bases de dades associades a les aplicacions.")
@RestController
...
public class AppDatabaseController {
    ...
    /** Service facade handling business operations for application-database links. */
