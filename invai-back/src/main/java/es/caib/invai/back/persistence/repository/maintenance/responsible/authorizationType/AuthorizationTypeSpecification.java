 ...
 * structures using the Criteria API targeting AuthorizationType entities.
 *
 * @since 1.0.3
 */
@NoArgsConstructor
public final class AuthorizationTypeSpecification {

    /**
     * Builds a JPA {@link Specification} that filters {@link AuthorizationTypeEntity} records
     ...
     */
    public static Specification<AuthorizationTypeEntity> filterByCriteria(AuthorizationTypeCriteria criteria) {
