 ...
 * and constraint validation checks targeting live {@link SecurityMeasureTypeEntity} records.
 *
 * @since 1.0.4
 */
@Repository
public interface SecurityMeasureTypeJPARepository extends JpaRepository<SecurityMeasureTypeEntity, Long>, JpaSpecificationExecutor<SecurityMeasureTypeEntity> {
