...
public class CategoryRepositoryAdapter implements CategoryRepository {
    ...
    /** Spring Data JPA repository providing CRUD access to live {@link CategoryEntity} records. */
    @Autowired
    private CategoryJPARepository categoryJPARepository;

    /** Spring Data JPA repository providing CRUD access to historical {@link CategoryAudEntity} audit snapshots. */
    @Autowired
    private CategoryAudJPARepository categoryAudJPARepository;

    /** Mapper converting between Category domain models and persistence entities. */
    @Autowired
     ...
     */
    @Override
    public Page<Category> findAll(CategoryCriteria filter, Pageable pageable) {
        Specification<CategoryEntity> spec = CategorySpecification.filterByCriteria(filter);
        return categoryJPARepository.findAll(spec, pageable).map(categoryMapper::toModel);
    }
