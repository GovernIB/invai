...
public class CommissionRepositoryAdapter implements CommissionRepository {
    ...
    /** JPA repository providing CRUD access to live Commission entities. */
    @Autowired
    private CommissionJPARepository commissionJPARepository;

    /** JPA repository providing persistence of historical Commission audit snapshots. */
    @Autowired
    private CommissionAudJPARepository commissionAudJPARepository;

    /** Mapper used to convert between Commission domain models and their entity representations. */
    @Autowired
