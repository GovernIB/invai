 ...
 * to build dynamic database queries targeting the SecurityMeasureType registry ecosystem.
 *
 * @since 1.0.4
 */
@Getter
...
@NoArgsConstructor
@AllArgsConstructor
public class SecurityMeasureTypeCriteria {

    /** Security measure type descriptive label used to filter results (partial, case-insensitive match). */
    private String name;
