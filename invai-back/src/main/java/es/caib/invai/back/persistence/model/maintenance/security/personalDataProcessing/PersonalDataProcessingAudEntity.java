 ...
 * targeting the {@code INV_PERSONAL_DATA_PROCESSING} database table.
 *
 * @since 1.0.4
 */
@Getter
@Setter
@Entity
@Table(name = "INV_PERS_DATA_PROC_AUD")
public class PersonalDataProcessingAudEntity {

    /** Unique auto-generated primary key of the audit record. */
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "inv_pers_data_proc_aud_seq")
    @SequenceGenerator(name = "inv_pers_data_proc_aud_seq", sequenceName = "INV_PERS_DATA_PROC_AUD_SEQ", allocationSize = 1)
    @Column(name = "AUDIT_ID", nullable = false, updatable = false)
    private Long auditId;

    /** Identifier of the {@code PersonalDataProcessingEntity} this audit snapshot refers to. */
    @Column(name = "PERSONAL_DATA_PROCESSING_ID", nullable = false)
    private Long personalDataProcessingId;

    /** Personal data processing entry descriptive label captured at the time of the audited change. */
