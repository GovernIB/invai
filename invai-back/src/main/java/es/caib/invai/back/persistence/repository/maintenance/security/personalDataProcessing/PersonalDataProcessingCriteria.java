 ...
 * to build dynamic database queries targeting the PersonalDataProcessing registry ecosystem.
 *
 * @since 1.0.4
 */
@Getter
...
@NoArgsConstructor
@AllArgsConstructor
public class PersonalDataProcessingCriteria {

    /** Personal data processing entry descriptive label used to filter results (partial, case-insensitive match). */
    private String name;
