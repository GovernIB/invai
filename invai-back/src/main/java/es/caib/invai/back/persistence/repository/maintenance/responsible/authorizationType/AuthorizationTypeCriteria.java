 ...
 * to build dynamic database queries targeting the AuthorizationType registry ecosystem.
 *
 * @since 1.0.3
 */
@Getter
...
@NoArgsConstructor
@AllArgsConstructor
public class AuthorizationTypeCriteria {

    /** Authorization type descriptive label used to filter results (partial, case-insensitive match). */
    private String name;
