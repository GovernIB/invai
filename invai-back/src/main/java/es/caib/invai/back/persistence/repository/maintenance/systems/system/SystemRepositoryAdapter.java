...
public class SystemRepositoryAdapter implements SystemRepository {
    ...
    /** JPA repository providing CRUD and specification-based query access to the system entity. */
    @Autowired
    private SystemJPARepository systemJPARepository;

    /** JPA repository used to persist the historical audit trail for the system entity. */
    @Autowired
    private SystemAudJPARepository systemAudJPARepository;

    /** Mapper converting between the system entity and its business domain model. */
    @Autowired
