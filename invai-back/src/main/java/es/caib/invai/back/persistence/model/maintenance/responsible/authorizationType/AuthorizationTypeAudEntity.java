 ...
 * targeting the {@code INV_AUTHORIZATION_TYPE} database table.
 *
 * @since 1.0.3
 */
@Getter
@Setter
@Entity
@Table(name = "INV_AUTHORIZATION_TYPE_AUD")
public class AuthorizationTypeAudEntity {

    /** Unique auto-generated primary key of the audit record. */
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "inv_authorization_type_aud_seq")
    @SequenceGenerator(name = "inv_authorization_type_aud_seq", sequenceName = "INV_AUTHORIZATION_TYPE_AUD_SEQ", allocationSize = 1)
    @Column(name = "AUDIT_ID", nullable = false, updatable = false)
    private Long auditId;

    /** Identifier of the {@code AuthorizationTypeEntity} this audit snapshot refers to. */
    @Column(name = "AUTHORIZATION_TYPE_ID", nullable = false)
    private Long authorizationTypeId;

    /** Authorization type descriptive label captured at the time of the audited change. */
