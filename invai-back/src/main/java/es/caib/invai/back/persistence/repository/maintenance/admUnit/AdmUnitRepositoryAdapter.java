...
public class AdmUnitRepositoryAdapter implements AdmUnitRepository {
    ...
    /** Spring Data JPA repository used to perform CRUD operations on live administrative unit entities. */
    @Autowired
    private AdmUnitJPARepository admUnitJPARepository;

    /** Spring Data JPA repository used to persist historical audit snapshots of administrative unit entities. */
    @Autowired
    private AdmUnitAudJPARepository admUnitAudJPARepository;

    /** Mapper used to convert between administrative unit domain models and JPA entities. */
    @Autowired
