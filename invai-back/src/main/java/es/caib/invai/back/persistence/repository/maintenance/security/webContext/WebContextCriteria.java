 ...
 * to build dynamic database queries targeting the WebContext registry ecosystem.
 *
 * @since 1.0.4
 */
@Getter
...
@NoArgsConstructor
@AllArgsConstructor
public class WebContextCriteria {

    /** Web context descriptive label used to filter results (partial, case-insensitive match). */
    private String name;
