 ...
 * structures using the Criteria API targeting EnsRequirement entities.
 *
 * @since 1.0.4
 */
@NoArgsConstructor
public final class EnsRequirementSpecification {

    /**
     * Builds a JPA {@link Specification} that filters {@link EnsRequirementEntity} records
     ...
     */
    public static Specification<EnsRequirementEntity> filterByCriteria(EnsRequirementCriteria criteria) {
