 ...
 * structures using the Criteria API targeting ComplianceSituation entities.
 *
 * @since 1.0.4
 */
@NoArgsConstructor
public final class ComplianceSituationSpecification {

    /**
     * Builds a JPA {@link Specification} that filters {@link ComplianceSituationEntity} records
     ...
     */
    public static Specification<ComplianceSituationEntity> filterByCriteria(ComplianceSituationCriteria criteria) {
