...
public class EnvironmentRepositoryAdapter implements EnvironmentRepository {
    ...
    /** JPA repository providing CRUD and specification-based query access to the environment entity. */
    @Autowired
    private EnvironmentJPARepository environmentJPARepository;

    /** JPA repository used to persist the historical audit trail for the environment entity. */
    @Autowired
    private EnvironmentAudJPARepository environmentAudJPARepository;

    /** Mapper converting between the environment entity and its business domain model. */
    @Autowired
