 ...
 * and constraint validation checks targeting live {@link ComplianceSituationEntity} records.
 *
 * @since 1.0.4
 */
@Repository
public interface ComplianceSituationJPARepository extends JpaRepository<ComplianceSituationEntity, Long>, JpaSpecificationExecutor<ComplianceSituationEntity> {
