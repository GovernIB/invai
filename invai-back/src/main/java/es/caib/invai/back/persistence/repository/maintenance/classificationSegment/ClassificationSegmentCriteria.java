 ...
 * to build dynamic database queries targeting the ClassificationSegment registry ecosystem.
 *
 * @since 1.0.4
 */
@Getter
...
@NoArgsConstructor
@AllArgsConstructor
public class ClassificationSegmentCriteria {

    /** Classification segment descriptive label used to filter results (partial, case-insensitive match). */
    private String name;
