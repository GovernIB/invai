 ...
 * to build dynamic database queries targeting the ComplianceSituation registry ecosystem.
 *
 * @since 1.0.4
 */
@Getter
...
@NoArgsConstructor
@AllArgsConstructor
public class ComplianceSituationCriteria {

    /** Compliance situation descriptive label used to filter results (partial, case-insensitive match). */
    private String name;
