 ...
 * structures using the Criteria API targeting WebContext entities.
 *
 * @since 1.0.4
 */
@NoArgsConstructor
public final class WebContextSpecification {

    /**
     * Builds a JPA {@link Specification} that filters {@link WebContextEntity} records
     ...
     */
    public static Specification<WebContextEntity> filterByCriteria(WebContextCriteria criteria) {
