 ...
 * structures using the Criteria API targeting SecurityMeasureType entities.
 *
 * @since 1.0.4
 */
@NoArgsConstructor
public final class SecurityMeasureTypeSpecification {

    /**
     * Builds a JPA {@link Specification} that filters {@link SecurityMeasureTypeEntity} records
     ...
     */
    public static Specification<SecurityMeasureTypeEntity> filterByCriteria(SecurityMeasureTypeCriteria criteria) {
