...
@Slf4j
@Validated
@Tag(name = "Sistemes d'informació", description = "Servei de gestió dels sistemes d'informació de bases de dades associats a les aplicacions.")
@RestController
...
public class AppInformationSystemDbController {
    ...
    /** Service facade handling business operations for information system database groupings. */
