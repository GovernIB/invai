...
/**
 * Unit tests for {@link AuthorizationTypeSpecification}, verifying that each {@link AuthorizationTypeCriteria}
 * field builds the expected JPA Criteria predicate against a fully mocked {@link CriteriaBuilder}.
 */
@ExtendWith(MockitoExtension.class)
class AuthorizationTypeSpecificationTest {

    @Mock
    private Root<AuthorizationTypeEntity> root;
    ...
    void filterByCriteria_nullCriteria_buildsEmptyConjunction() {
        Specification<AuthorizationTypeEntity> spec = AuthorizationTypeSpecification.filterByCriteria(null);
    ...
    void filterByCriteria_activeStatus_addsIsNullDeletedAtPredicate() {
        ...
        AuthorizationTypeSpecification.filterByCriteria(criteria).toPredicate(root, query, cb);
