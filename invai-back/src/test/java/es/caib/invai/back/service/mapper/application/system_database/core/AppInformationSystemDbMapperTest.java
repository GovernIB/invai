...
class AppInformationSystemDbMapperTest {
    ...
    private AppInformationSystemDbMapper mapper;
    ...
    void toModel_deepEntityGraph_mapsEveryNestedField() {
        ...
        AppInformationSystemDb model = mapper.toModel(entity);
    ...
    void toEntity_deepModelGraph_mapsEveryNestedField() {
        ...
        AppInformationSystemDbEntity entity = mapper.toEntity(model);
    ...
    void toResponse_deepModel_flattensEveryNestedFieldIntoOutputDTO() {
        ...
        AppInformationSystemDbOutputDTO response = mapper.toResponse(model);
    ...
    void toModelFromInput_resolvesApplicationIdAndIgnoresAuditFields() {
        AppInformationSystemDbInputDTO inputDTO = new AppInformationSystemDbInputDTO(50L, "Fresh notes");

        AppInformationSystemDb model = mapper.toModelFromInput(inputDTO);
    ...
    void updateModelFromInput_mergesFieldsWithoutTouchingId() {
        ...
        AppInformationSystemDb existing = new AppInformationSystemDb();
        existing.setId(4L);
        existing.setApplication(existingApplication);
        existing.setObservation("Old notes");
        AppInformationSystemDbInputDTO inputDTO = new AppInformationSystemDbInputDTO(70L, "New notes");
    ...
    void updateModelFromInput_whenExistingApplicationIsNull_createsIt() {
        AppInformationSystemDb existing = new AppInformationSystemDb();
        existing.setId(8L);
        AppInformationSystemDbInputDTO inputDTO = new AppInformationSystemDbInputDTO(80L, "Created notes");
