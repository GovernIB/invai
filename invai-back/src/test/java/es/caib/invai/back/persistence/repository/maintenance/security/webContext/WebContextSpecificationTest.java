...
/**
 * Unit tests for {@link WebContextSpecification}, verifying that each {@link WebContextCriteria}
 * field builds the expected JPA Criteria predicate against a fully mocked {@link CriteriaBuilder}.
 */
@ExtendWith(MockitoExtension.class)
class WebContextSpecificationTest {

    @Mock
    private Root<WebContextEntity> root;
    ...
    void filterByCriteria_nullCriteria_buildsEmptyConjunction() {
        Specification<WebContextEntity> spec = WebContextSpecification.filterByCriteria(null);
    ...
    void filterByCriteria_activeStatus_addsIsNullDeletedAtPredicate() {
        ...
        WebContextSpecification.filterByCriteria(criteria).toPredicate(root, query, cb);
