...
/**
 * Unit tests for {@link AdmUnitSpecification}, verifying that each {@link AdmUnitCriteria} field
 * builds the expected JPA Criteria predicate against a fully mocked {@link CriteriaBuilder}.
 */
@ExtendWith(MockitoExtension.class)
class AdmUnitSpecificationTest {

    @Mock
    private Root<AdmUnitEntity> root;
    ...
    void filterByCriteria_nullCriteria_buildsEmptyConjunction() {
        Specification<AdmUnitEntity> spec = AdmUnitSpecification.filterByCriteria(null);
    ...
    void filterByCriteria_activeStatus_addsIsNullDeletedAtPredicate() {
        ...
        AdmUnitSpecification.filterByCriteria(criteria).toPredicate(root, query, cb);
    ...
    void filterByCriteria_withName_addsLikePredicateOnLoweredName() {
        AdmUnitCriteria criteria = new AdmUnitCriteria();
        criteria.setName("Production");

        AdmUnitSpecification.filterByCriteria(criteria).toPredicate(root, query, cb);

        verify(cb).like(eq(path), eq("%production%"));
    }
